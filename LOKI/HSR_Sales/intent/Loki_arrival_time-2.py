...
"""
    Loki module for arrival_time-2
...
if CHATBOT_MODE:
    try:
        responseDICT = json.load(open(os.path.join(os.path.dirname(os.path.dirname(__file__)), "reply/reply_arrival_time-2.json"), encoding="utf-8"))
    except Exception as e:
...
def debugInfo(inputSTR, utterance):
    if DEBUG:
        print("[arrival_time-2] {} ===> {}".format(inputSTR, utterance))
